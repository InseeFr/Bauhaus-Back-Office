...
public class MetadataReportResources {
    ...
    public MetadataReportResources(
    ...
    public DocumentationAttribute getMetadataAttribute(@PathVariable(Constants.ID) String id)
    ...
    @HasAccess(module = RBAC.Module.OPERATION_SIMS, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/metadataAttributes",
            produces = {MediaType.APPLICATION_JSON_VALUE, "application/hal+json"})
    public ResponseEntity<List<DocumentationAttributeResponse>> getMetadataAttributes()
        ...
        List<DocumentationAttributeResponse> responses = attributes.stream()
                .map(attribute -> {
                    ...
                    response.add(linkTo(MetadataReportResources.class)
                            .slash("metadataAttribute")
                            .slash(attribute.id())
                            .withSelfRel());
                    return response;
                })
    ...
    @HasAccess(module = RBAC.Module.OPERATION_SIMS, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/metadataReport/fullSims/{id}",
            produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    public ResponseEntity<Object> setMetadataReportById(@PathVariable(Constants.ID) String id, @RequestBody String body)
            throws RmesException {
    ...
    public ResponseEntity<String> setSimsValidation(@PathVariable(Constants.ID) String id) throws RmesException {
    ...
    @HasAccess(module = RBAC.Module.OPERATION_SIMS, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/metadataReport/export/{id}",
    ...
    @HasAccess(module = RBAC.Module.OPERATION_SIMS, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/metadataReport/export/label/{id}",
            produces = {MediaType.APPLICATION_OCTET_STREAM_VALUE, "application/vnd.oasis.opendocument.text"})
    ...
    @HasAccess(module = RBAC.Module.OPERATION_SIMS, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/metadataReport/export/{id}/tempFiles",
            produces = {MediaType.APPLICATION_OCTET_STREAM_VALUE, "application/vnd.oasis.opendocument.text"})
