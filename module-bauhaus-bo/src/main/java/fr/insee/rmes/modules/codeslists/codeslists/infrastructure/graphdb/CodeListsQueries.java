...
public class CodeListsQueries {
    ...
    public String getDetailedCodes(
            String notation, CodeListKind kind, List<String> search, int page, Integer perPage, String sort)
    ...
    private static String sortColumn(String sort) {
        ...
        if (!SORTABLE_COLUMNS.contains(sort)) {
            throw new RmesRuntimeBadRequestException(
                    "Unknown sort column: " + sort + ". Expected one of " + SORTABLE_COLUMNS);
        }
        return sort;
    }
    ...
    public String getCodesListContributors(String IRI) throws RmesException {
        Map<String, Object> params = Map.of(
                "GRAPH",
                SparqlLiterals.iri(graphs.codeListGraph()),
                "IRI",
                SparqlLiterals.iri(IRI),
                "PREDICATE",
                "dc:contributor");
