...
public class ClassificationsResources {
    ...
    final ClassificationsService classificationsService;

    final ClassificationItemService classificationItemService;

    public ClassificationsResources(
            ClassificationsService classificationsService, ClassificationItemService classificationItemService) {
    ...
    public ResponseEntity<List<PartialClassificationFamilyResponse>> getFamilies() throws RmesException {
        ...
        List<PartialClassificationFamilyResponse> responses = families.stream()
                .map(family -> {
                    ...
                    response.add(linkTo(ClassificationsResources.class)
                            .slash("family")
                            .slash(family.id())
                            .withSelfRel());
                    return response;
    ...
    public ResponseEntity<Id> publishClassification(@PathVariable(Constants.ID) Id id) throws RmesException {
    ...
    public ResponseEntity<Object> getClassificationLevel(
            @PathVariable(Constants.ID) String id, @PathVariable("levelId") String levelId) throws RmesException {
    ...
    @HasAccess(module = RBAC.Module.CLASSIFICATION_CLASSIFICATION, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/classification/{classificationId}/level/{levelId}/members",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Object> getClassificationLevelMembers(
            @PathVariable("classificationId") String classificationId, @PathVariable("levelId") String levelId)
            throws RmesException {
    ...
    public ResponseEntity<Object> getClassificationItem(
    ...
    @HasAccess(module = RBAC.Module.CLASSIFICATION_CLASSIFICATION, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/classification/{classificationId}/item/{itemId}/notes/{conceptVersion}",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Object> getClassificationItemNotes(
            @PathVariable("classificationId") String classificationId,
            @PathVariable("itemId") String itemId,
            @PathVariable("conceptVersion") int conceptVersion)
            throws RmesException {
    ...
    @HasAccess(module = RBAC.Module.CLASSIFICATION_CLASSIFICATION, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/classification/{classificationId}/item/{itemId}/narrowers",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Object> getClassificationItemNarrowers(
            @PathVariable("classificationId") String classificationId, @PathVariable("itemId") String itemId)
            throws RmesException {
    ...
    @HasAccess(module = RBAC.Module.CLASSIFICATION_CLASSIFICATION, privilege = RBAC.Privilege.READ)
    @GetMapping(
            value = "/correspondence/{correspondenceId}/association/{associationId}",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Object> getCorrespondenceItem(
            @PathVariable("correspondenceId") String correspondenceId,
