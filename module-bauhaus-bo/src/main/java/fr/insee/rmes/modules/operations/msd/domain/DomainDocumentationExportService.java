...
public class DomainDocumentationExportService implements DocumentationExportService {

    private final DocumentationExportGateway gateway;

    public DomainDocumentationExportService(DocumentationExportGateway gateway) {
