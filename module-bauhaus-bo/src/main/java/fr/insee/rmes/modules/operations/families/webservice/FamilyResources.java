...
public class FamilyResources  {
	...
	public ResponseEntity<Object> setFamilyById(
			...
			@Valid @RequestBody FamilyRequest family) throws RmesException {
		try {
			familyService.updateFamily(family.toUpdateCommand(id));
		} catch (FamilyNotFoundException e) {
			throw new RmesNotFoundException(ErrorCodes.FAMILY_UNKNOWN_ID, e.getMessage(), "Can't update non-existant family");
