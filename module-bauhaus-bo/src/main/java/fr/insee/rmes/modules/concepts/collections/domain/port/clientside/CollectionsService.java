...
public interface CollectionsService {
    ...
    void syncConceptCollections(String conceptId, List<String> newCollectionIds)
            throws CollectionsSaveException, CollectionsFetchException;

    void publishCollections(List<CollectionId> collectionIds)
