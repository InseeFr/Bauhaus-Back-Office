...
public class RdfUtils {
    ...
    public static BNode createBlankNode() {
    ...
    public static IRI versionableNoteIRI(String conceptId, VersionableNote versionableNote) {
        return RdfUtils.factory.createIRI(bauhausUriBuilder.getBaseUriGestion(ObjectType.CONCEPT)
                + "/" + conceptId
    ...
    public static IRI datableNoteIRI(String conceptId, DatableNote datableNote) {
        ...
        return RdfUtils.factory.createIRI(bauhausUriBuilder.getBaseUriGestion(ObjectType.CONCEPT) + "/" + conceptId
                + "/" + datableNote.getPath() + "/" + parsedDate + "/" + datableNote.getLang());
    }
    ...
    public static void addTripleString(
            IRI objectURI, IRI predicat, String value, String lang, Model model, Resource graph) {
        if (value != null && !value.isEmpty()) {
            model.add(objectURI, predicat, RdfUtils.setLiteralString(value, lang), graph);
        }
    }

    public static void addTripleStringMdToXhtml(
            IRI objectURI, IRI predicat, String value, String lang, Model model, Resource graph) {
        if (value != null && !value.isEmpty()) {
