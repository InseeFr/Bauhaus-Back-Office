...
public class ClassificationRepository extends RdfService {
    ...
    public void updateClassification(Classification classification, String uri) throws RmesException {
        ...
        logger.debug(
                "updateClassification - values converted to IRI: creator={}, contributor={}, idSeries={}, additionalMaterial={}, legalMaterial={}, homepage={}, idBefore={}, idAfter={}, idVariant={}",
                classification.getCreator(),
                classification.getContributor(),
                classification.getIdSeries(),
                classification.getAdditionalMaterial(),
                classification.getLegalMaterial(),
                classification.getHomepage(),
                classification.getIdBefore(),
                classification.getIdAfter(),
                classification.getIdVariant());
        ...
        model.add(
                classificationIri,
                SKOS.PREF_LABEL,
                RdfUtils.setLiteralString(classification.getPrefLabelLg1(), languages.lg1()),
                graph);
        model.add(
                classificationIri,
                SKOS.PREF_LABEL,
                RdfUtils.setLiteralString(classification.getPrefLabelLg2(), languages.lg2()),
                graph);
        ...
        if (classification.getAltLabelLg1() != null) {
            model.add(
                    classificationIri,
                    SKOS.ALT_LABEL,
                    RdfUtils.setLiteralString(classification.getAltLabelLg1(), languages.lg1()),
                    graph);
        }
        ...
        if (classification.getAltLabelLg2() != null) {
            model.add(
                    classificationIri,
                    SKOS.ALT_LABEL,
                    RdfUtils.setLiteralString(classification.getAltLabelLg2(), languages.lg2()),
                    graph);
        }
        ...
        if (classification.getDescriptionLg1() != null) {
            model.add(
                    classificationIri,
                    DC.DESCRIPTION,
                    RdfUtils.setLiteralString(classification.getDescriptionLg1(), languages.lg1()),
                    graph);
        }
        ...
        if (classification.getDescriptionLg2() != null) {
            model.add(
                    classificationIri,
                    DC.DESCRIPTION,
                    RdfUtils.setLiteralString(classification.getDescriptionLg2(), languages.lg2()),
                    graph);
        }
        ...
        if (classification.getIdSeries() != null) {
            ...
            model.add(
                    classificationIri,
                    XKOS.BELONGS_TO,
                    RdfUtils.classificationSerieIRI(classification.getIdSeries()),
                    graph);
        }

        repoGestion.deleteTripletByPredicate(classificationIri, DC.CREATOR, graph, null);
        logger.debug(
                "updateClassification - dc:creator, raw value expected to be an absolute IRI = [{}]",
                classification.getCreator());
        ...
        logger.debug(
                "updateClassification - dc:contributor, raw value expected to be an absolute IRI = [{}]",
                classification.getContributor());
        ...
        if (StringUtils.isNotEmpty(classification.getAdditionalMaterial())) {
            logger.debug(
                    "updateClassification - insee:additionalMaterial = [{}]", classification.getAdditionalMaterial());
            model.add(
                    classificationIri,
                    INSEE.ADDITIONALMATERIAL,
                    RdfUtils.createIRI(classification.getAdditionalMaterial()),
                    graph);
        }
        ...
        if (StringUtils.isNotEmpty(classification.getLegalMaterial())) {
            ...
            model.add(
                    classificationIri,
                    INSEE.LEGALMATERIAL,
                    RdfUtils.createIRI(classification.getLegalMaterial()),
                    graph);
        }
        ...
        if (classification.getDisseminationStatus() != null) {
            model.add(
                    ...
                    RdfUtils.setLiteralString(classification.getDisseminationStatus()),
                    graph);
        }
        ...
        logger.debug(
                "updateClassification - validationGraph (classifFamiliesGraph) = [{}]", graphs.classifFamiliesGraph());
        ...
        ValidationStatus newValidationState = ValidationStatus.VALIDATED
                                .getValue()
                                .equalsIgnoreCase(classification.getValidationState())
        ...
        model.add(
                ...
                RdfUtils.setLiteralString(newValidationState),
                validationGraph);
        ...
        this.classificationNoteService.addNotes(
                graph, classification.getChangeNoteUriLg1(), classification.getChangeNoteLg1(), model);
        this.classificationNoteService.addNotes(
                graph, classification.getChangeNoteUriLg2(), classification.getChangeNoteUriLg2(), model);
        this.classificationNoteService.addNotes(
                graph, classification.getScopeNoteUriLg1(), classification.getScopeNoteLg1(), model);
        this.classificationNoteService.addNotes(
                graph, classification.getScopeNoteUriLg2(), classification.getScopeNoteLg2(), model);
