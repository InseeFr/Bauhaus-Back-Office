...
public class ClassificationsServiceImpl implements ClassificationsService {
    ...
    public ClassificationsServiceImpl(
            ...
            ClassificationRepository classificationUtils,
            ClassificationPublication classificationPublication,
            ClassificationsQueries classificationsQueries,
            ClassificationLevelsQueries classificationLevelsQueries,
            ClassificationSeriesQueries classificationSeriesQueries,
            ClassificationFamiliesQueries classificationFamiliesQueries,
    ...
    public List<PartialClassificationFamily> getFamilies() throws RmesException {
        ...
        return DiacriticSorter.sort(families, PartialClassificationFamily[].class, PartialClassificationFamily::label);
    }
    ...
    public String getFamily(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsObject(classificationFamiliesQueries.familyQuery(id))
                .toString();
    }
    ...
    public String getFamilyMembers(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationFamiliesQueries.familyMembersQuery(id))
                .toString();
    }
    ...
    public List<PartialClassificationSeries> getSeries() throws RmesException {
        ...
        return DiacriticSorter.sortGroupingByIdConcatenatingAltLabels(
                series, PartialClassificationSeries[].class, PartialClassificationSeries::label);
    }
    ...
    public String getOneSeries(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsObject(classificationSeriesQueries.oneSeriesQuery(id))
                .toString();
    }
    ...
    public String getSeriesMembers(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationSeriesQueries.seriesMembersQuery(id))
                .toString();
    }
    ...
    public List<PartialClassification> getClassifications() throws RmesException {
        ...
        return DiacriticSorter.sortGroupingByIdConcatenatingAltLabels(
                collections, PartialClassification[].class, PartialClassification::label);
    }
    ...
    public void updateClassification(String id, String body) throws RmesException {
        ...
        String uri = repoGestion
                .getResponseAsObject(classificationsQueries.classificationQueryUri(classification.getId()))
                .getString("iri");
    ...
    public String getClassificationLevels(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationLevelsQueries.levelsQuery(id))
                .toString();
    }
    ...
    public String getClassificationLevel(String classificationId, String levelId) throws RmesException {
        ...
        return repoGestion
                .getResponseAsObject(classificationLevelsQueries.levelQuery(classificationId, levelId))
                .toString();
    }
    ...
    public String getClassificationLevelMembers(String classificationId, String levelId) throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationLevelsQueries.levelMembersQuery(classificationId, levelId))
                .toString();
    }
    ...
    public String getCorrespondences() throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationCorrespondencesQueries.correspondencesQuery())
                .toString();
    }
    ...
    public String getCorrespondence(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsObject(classificationCorrespondencesQueries.correspondenceQuery(id))
                .toString();
    }
    ...
    public String getCorrespondenceAssociations(String id) throws RmesException {
        ...
        return repoGestion
                .getResponseAsArray(classificationCorrespondencesQueries.correspondenceAssociationsQuery(id))
                .toString();
    }
    ...
    public String getCorrespondenceAssociation(String correspondenceId, String associationId) throws RmesException {
        ...
        return repoGestion
                .getResponseAsObject(classificationCorrespondencesQueries.correspondenceAssociationQuery(
                        correspondenceId, associationId))
                .toString();
    }
    ...
    public void setClassificationValidation(String classificationId) throws RmesException {
        ...
        // GET graph
        JSONObject listGraph =
                repoGestion.getResponseAsObject(classificationsQueries.getGraphUriById(classificationId));
        logger.debug("JSON for listGraph id : {}", listGraph);
        if (listGraph.isEmpty()) {
            throw new RmesNotFoundException(
                    ErrorCodes.CLASSIFICATION_UNKNOWN_ID, "Classification not found", classificationId);
        }
        JSONObject classification =
                repoGestion.getResponseAsObject(classificationsQueries.classificationQuery(classificationId));
        PublicationUtils.rejectIfAlreadyPublished(
                "Classification", classificationId, classification.optString("validationState"));
        ...
        try {
            ...
            logger.error(
                    "setClassificationValidation - INCONSISTENT STATE: classification {} was published from graph {} "
                            + "but the management repository could not be marked as {}. Publication and management repositories are out of sync; "
                            + "replay the validation for this classification.",
                    classificationId,
                    graphIri,
        ...
        logger.debug(
                "setClassificationValidation - validation state updated in the management repository for {}",
                classifUriString);
    }
}
