...
public class ErrorCodes {
    ...
    // FAMILY
    public static final String OPERATION_FAMILY_EXISTING_PREF_LABEL_LG1 =
            "406_OPERATION_FAMILY_OPERATION_FAMILY_EXISTING_PREF_LABEL_LG1";
    public static final String OPERATION_FAMILY_EXISTING_PREF_LABEL_LG2 =
    ...
    public static final String OPERATION_DOCUMENT_LINK_EXISTING_LABEL_LG1 =
            "406_OPERATION_DOCUMENT_OPERATION_DOCUMENT_LINK_EXISTING_LABEL_LG1";
    public static final String OPERATION_DOCUMENT_LINK_EXISTING_LABEL_LG2 =
    ...
    // SERIES
    public static final String OPERATION_SERIES_EXISTING_PREF_LABEL_LG1 =
            "406_OPERATION_SERIES_OPERATION_SERIES_EXISTING_PREF_LABEL_LG1";
    public static final String OPERATION_SERIES_EXISTING_PREF_LABEL_LG2 =
            "406_OPERATION_SERIES_OPERATION_SERIES_EXISTING_PREF_LABEL_LG2";

    public static final String OPERATION_OPERATION_EXISTING_PREF_LABEL_LG1 =
            "406_OPERATION_OPERATION_OPERATION_OPERATION_EXISTING_PREF_LABEL_LG1";
    public static final String OPERATION_OPERATION_EXISTING_PREF_LABEL_LG2 =
