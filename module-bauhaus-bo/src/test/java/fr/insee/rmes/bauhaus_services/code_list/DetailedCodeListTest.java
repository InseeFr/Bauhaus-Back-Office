...
class DetailedCodeListTest {
    ...
    void shouldVerifyClassFunctionality() {
        ...
        boolean checkCodeListLabelLg1 =
                Objects.equals(detailedCodeList.getCodeListLabelLg1(), "mockedCodeListLabelLg1");
        boolean checkCodeListLabelLg2 =
                Objects.equals(detailedCodeList.getCodeListLabelLg2(), "mockedCodeListLabelLg2");
