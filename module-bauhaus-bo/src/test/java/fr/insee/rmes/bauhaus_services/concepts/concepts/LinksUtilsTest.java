...
class LinksUtilsTest {
    ...
    static void initConfig() {
        ...
        RdfUtils.setBauhausUriBuilder(new BauhausUriBuilder("http://bauhaus/publication/", "http://bauhaus/",
                p -> Optional.of("/concepts/definition")));
    }
    ...
    void shouldBuildCloseMatchFromTheUrnAndNotFromTheIds() throws RmesException {
        ...
        assertThat(model).containsExactly(
                statement(SOURCE, SKOS.CLOSE_MATCH, FACTORY.createIRI("http://external/concept/42")));
    }
