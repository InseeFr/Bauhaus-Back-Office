...
class FilesUtilsTest {
    ...
    void testGenerateFinalFileNameWithExtension_LongFileName() {
        ...
        assertEquals(
                "averylongfilena.txt",
                result,
                "Le nom de fichier généré avec extension pour un long nom est incorrect");
    }
    ...
    void testGenerateFinalFileNameWithoutExtension_LongFileName() {
        ...
        assertEquals(
                "rapportQualiteEnquet",
                FilesUtils.generateFinalFileNameWithoutExtension(
                        "Rapport qualité : Enquête annuelle de recensement 2022", maxLength),
                "Le nom de fichier généré sans extension pour un long nom est incorrect");
        assertEquals(
    ...
    void testGetMediaTypeFromExtension_validExtensions() {
        ...
        assertEquals(
                new MediaType("application", "vnd.oasis.opendocument.text"),
        ...
        assertEquals(
                new MediaType("application", "zip"), FilesUtils.getMediaTypeFromExtension(FilesUtils.ZIP_EXTENSION));
    }
    ...
    void generate_final_file_name_should_transliterate_letters_that_have_no_diacritic_to_strip() {
        assertEquals(
                "coeurAequoOstStrasse", FilesUtils.generateFinalFileNameWithoutExtension("Cœur æquo Øst Straße", 50));
    }
    ...
    void generate_final_file_name_should_remove_typographic_punctuation() {
        assertEquals(
                "enqueteEmploi2022N1",
                FilesUtils.generateFinalFileNameWithoutExtension("Enquête « Emploi » – 2022 … n°1", 50));
    }

    @Test
    void generate_final_file_name_should_treat_a_non_breaking_space_as_a_word_separator() {
        assertEquals(
                "statistiques2024", FilesUtils.generateFinalFileNameWithoutExtension("Statistiques\u00A02024", 50));
    }
    ...
    void generate_final_file_name_should_only_keep_ascii_letters_and_digits() {
        ...
        assertTrue(
                ...
                "Le nom de fichier généré doit être purement ASCII, obtenu : " + result);
    }
