...
class XsltUtilsTest {
    ...
    void shouldBuildParamsWithCorrectDisplay() {
        ...
        boolean actualCorrespondToExpectedIncludeEmptyFields =
                List.of(true, true, true, true, true, true, true, true).equals(actualIncludeEmptyFields);
        boolean actualCorrespondToExpectedLanguage1 =
                List.of(true, true, true, true, false, false, false, false).equals(actualLanguage1);
        boolean actualCorrespondToExpectedLanguage2 =
                List.of(true, true, false, false, true, true, false, false).equals(actualLanguage2);

        assertTrue(actualCorrespondToExpectedIncludeEmptyFields
                && actualCorrespondToExpectedLanguage1
                && actualCorrespondToExpectedLanguage2);
    }
