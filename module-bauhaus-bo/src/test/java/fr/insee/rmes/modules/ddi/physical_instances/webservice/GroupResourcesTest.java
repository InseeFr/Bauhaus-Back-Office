...
class GroupResourcesTest {
    ...
    void getGroupResponses_shouldReturn200WithLinks() throws Exception, MissingUserInformationException {
        ...
        assertEquals(
                "http://localhost:8080/ddi/group/fr.insee/group-1",
                result.getFirst().getRequiredLink("self").getHref());

        assertEquals("group-2", result.get(1).getId());
        assertEquals(
                "http://localhost:8080/ddi/group/fr.insee/group-2",
    ...
    void getDdi4Group_shouldReturnGroupDetail() {
        ...
        assertEquals(
                "10a689ce-7006-429b-8e84-036b7787b422",
                responseBody.group().get(0).id());
    ...
    void getGroupMissingValuesRepresentations_shouldReturn200WithList() {
        List<PartialMissingValuesRepresentation> representations = List.of(new PartialMissingValuesRepresentation(
    ...
    private Ddi4GroupResponse createMockDdi4GroupResponse() {
        ...
        Reference topLevelRef = Reference.of("fr.insee", "10a689ce-7006-429b-8e84-036b7787b422", "1", "Group");

        return new Ddi4GroupResponse(
                "test-schema", List.of(topLevelRef), List.of(group), List.of(studyUnit1, studyUnit2));
    }
}
