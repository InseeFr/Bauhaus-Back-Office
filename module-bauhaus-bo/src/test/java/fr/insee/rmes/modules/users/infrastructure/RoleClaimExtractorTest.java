...
class RoleClaimExtractorTest {
    ...
    /** Claims holding, under {@code claimName}, a map whose "roles" entry is the given list. */
    private static Map<String, Object> claimsWithNestedRoles(String claimName, List<String> roles) {
        Map<String, Object> nestedMap = new HashMap<>();
        nestedMap.put("roles", roles);

        Map<String, Object> claims = new HashMap<>();
        claims.put(claimName, nestedMap);
        return claims;
    }

    private List<String> extractRoles(Map<String, Object> claims) {
        return roleClaimExtractor.extractRoles(claims).toList();
    }

    @Test
    void should_extract_roles_from_map_with_list() {
        Map<String, Object> claims = claimsWithNestedRoles("roles", List.of("ADMIN", "USER"));
    ...
    void should_extract_roles_from_map_with_nested_key() {
        ...
        Map<String, Object> claims = claimsWithNestedRoles("realm_access", List.of("ROLE_ADMIN", "ROLE_USER"));
    ...
    void should_return_empty_stream_for_empty_list() {
        Map<String, Object> claims = claimsWithNestedRoles("roles", List.of());
    ...
    void should_handle_single_role() {
        Map<String, Object> claims = claimsWithNestedRoles("roles", List.of("ADMIN"));
    ...
    void should_handle_many_roles() {
        Map<String, Object> claims =
                claimsWithNestedRoles("roles", List.of("ROLE_1", "ROLE_2", "ROLE_3", "ROLE_4", "ROLE_5"));
    ...
    void should_return_empty_stream_when_nested_key_is_missing_in_map() {
        ...
        Map<String, Object> claims = claimsWithNestedRoles("realm_access", List.of("ADMIN"));
    ...
    void should_extract_roles_with_special_characters() {
        Map<String, Object> claims =
                claimsWithNestedRoles("roles", List.of("ROLE:ADMIN", "ROLE-USER", "ROLE_MODERATOR"));
