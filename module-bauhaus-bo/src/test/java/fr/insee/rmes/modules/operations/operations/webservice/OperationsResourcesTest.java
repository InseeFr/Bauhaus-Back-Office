...
class OperationsResourcesTest {
    ...
    void setUp() {
        operationsResources =
                new OperationsResources(operationsService, documentationsService, ddiService, bauhausUriBuilder);
    }

    @Test
    void shouldGetOperations() throws RmesException {
        // Given
        PartialOperation operation1 =
                new PartialOperation("op1", "Label 1", "http://example.com/operation1", "series1", "Alt 1");
        PartialOperation operation2 =
                new PartialOperation("op2", "Label 2", "http://example.com/operation2", "series2", "Alt 2");
    ...
    void should_get_operations_with_hateoas_links() throws RmesException {
        ...
        Assertions.assertTrue(
                selfLink.contains("/operations/operation/op1"),
