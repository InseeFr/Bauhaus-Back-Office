...
@Import({SeriesResources.class, UserAuthTestConfiguration.class})
class TestSeriesResourcesEnvProd extends AbstractResourcesEnvProd {
    ...
    @ParameterizedTest
    void getSeries(String url, Integer code, boolean hasAccessReturn)
    ...
    void updateSeries(Integer code, boolean hasAccessReturn) throws Exception, MissingUserInformationException {
        ...
        var request = put("/operations/series/1")
