...
class ComponentDefinitionTest {
    ...
    void shouldReturnComponentDefinitionAttributes() throws RmesException {
        ...
        List<String> actualStringParameters = List.of(
                componentDefinition.getId(),
        ...
        Assertions.assertTrue(
                stringParameters && stringArrayParameter && mutualizedComponentParameter && booleanParameter);
    }
}
