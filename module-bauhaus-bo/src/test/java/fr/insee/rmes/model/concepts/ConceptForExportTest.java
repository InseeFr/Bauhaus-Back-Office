...
class ConceptForExportTest {
    ...
    void shouldAddNotesWhenJsonObjectAdded() {
        ...
        List<Boolean> conceptForExportAfter = List.of(
                scopeNoteLg1After,
                scopeNoteLg2After,
                definitionLg1After,
                definitionLg2After,
                editorialNoteLg1After,
                editorialNoteLg2After);
    ...
    void shouldAddLinksWhenJsonArrayAdded() {
        ...
        JSONObject jsonA = new JSONObject()
                .put("typeOfLink", "narrower")
                .put(Constants.PREF_LABEL_LG1, "A1")
                .put(Constants.PREF_LABEL_LG2, "A2");
        JSONObject jsonB = new JSONObject()
                .put("typeOfLink", "broader")
                .put(Constants.PREF_LABEL_LG1, "B1")
                .put(Constants.PREF_LABEL_LG2, "B2");
        JSONObject jsonC = new JSONObject()
                .put("typeOfLink", "references")
                .put(Constants.PREF_LABEL_LG1, "C1")
                .put(Constants.PREF_LABEL_LG2, "C2");
        JSONObject jsonD = new JSONObject()
                .put("typeOfLink", "succeed")
                .put(Constants.PREF_LABEL_LG1, "D1")
                .put(Constants.PREF_LABEL_LG2, "D2");
        JSONObject jsonE = new JSONObject()
                .put("typeOfLink", "related")
                .put(Constants.PREF_LABEL_LG1, "E1")
                .put(Constants.PREF_LABEL_LG2, "E2");
        JSONArray links =
                new JSONArray().put(jsonA).put(jsonB).put(jsonC).put(jsonD).put(jsonE);
        ...
        Boolean referencesLg1After =
                conceptForExport.getReferencesLg1().toString().equals(referencesLg1Before);
        Boolean referencesLg2After =
                conceptForExport.getReferencesLg2().toString().equals(referencesLg2Before);
        ...
        assertEquals(
                List.of(false, false, false, false, false, false, false, false, false, false), conceptForExportAfter);
    }
}
