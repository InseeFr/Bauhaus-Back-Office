...
class DocumentsQueriesTest {
    ...
    void setUp() {
        ...
        DocumentsQueries.setConfig(config);
    }
    ...
    void shouldCheckLabelUnicity() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.checkLabelUnicity("doc123", "Test Document", "en");
    ...
    void shouldDeleteDocument() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.deleteDocumentQuery(uri);
    ...
    void shouldGetDocumentUri() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentUriQuery("Test.PDF");
    ...
    void shouldGetDocumentsForSimsRubric() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentsForSimsRubricQuery("sims123", "rubric456", "fr");
    ...
    void shouldGetDocumentsForSims() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentsForSimsQuery("sims123");
    ...
    void shouldGetLinksForSims() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getLinksForSimsQuery("sims123");
    ...
    void shouldGetDocumentForDocument() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentQuery("doc123", false);
    ...
    void shouldGetDocumentForLink() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentQuery("link123", true);
    ...
    void shouldGetAllDocuments() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getAllDocumentsQuery();
    ...
    void shouldGetLinksToDocument() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getLinksToDocumentQuery("doc123");
    ...
    void shouldChangeDocumentUrl() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.changeDocumentUrlQuery("http://example.org/doc/123", "old.pdf", "new.pdf");
    ...
    void shouldGetLastDocumentID() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.lastDocumentID();
    ...
    void shouldGetLastLinkID() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.lastLinkID();
    ...
    void shouldGetDocumentsUriAndUrlForSims() throws RmesException {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            String result = DocumentsQueries.getDocumentsUriAndUrlForSims("sims123");
    ...
    void shouldPropagateRmesExceptionFromFreeMarkerUtils() {
        try (MockedStatic<FreeMarkerUtils> mockedFreeMarker = mockStatic(FreeMarkerUtils.class)) {
            ...
            RmesException exception = assertThrows(RmesException.class, () -> 
                DocumentsQueries.getDocumentQuery("test", false)
            );
