package fr.insee.rmes.bauhaus_services.sesame.concepts;
...
import fr.insee.rmes.bauhaus_services.sesame.concepts.collections.CollectionsUtils;
...
@Service
public class ConceptsImpl  extends SesameService implements ConceptsService {
	...
	public String deleteConcept(String id) throws RmesException {
		...
		String successMessage=THE_CONCEPT+id+" has been deleted from graph "+SesameUtils.conceptGraph();
		if (result!= Status.OK) {
