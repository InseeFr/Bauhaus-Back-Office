...
public class CorrespondencesQueries extends GenericQueries{
	...
	public static String correspondenceQuery(String id) {
		...
		return "SELECT ?id ?labelLg1 ?labelLg2 ?descriptionLg1 ?descriptionLg2 \n"
				...
				+ "FILTER (lang(?firstClassLabelLg1) = '" + config.getLg1() + "')  . \n"
				+ "OPTIONAL {?firstClassURI skos:prefLabel ?firstClassLabelLg2 . \n"
				+ "FILTER (lang(?firstClassLabelLg2) = '" + config.getLg2() + "') }  . \n"
				+ "OPTIONAL {?firstClassURI skos:altLabels ?firstAltLabelLg1 . \n"
				+ "FILTER (lang(?firstAltLabelLg1) = '" + config.getLg1() + "') } . \n"
				+ "OPTIONAL {?firstClassURI skos:altLabels ?firstAltLabelLg2 . \n"
				+ "FILTER (lang(?firstAltLabelLg2) = '" + config.getLg2() + "') } . \n"
				...
				+ "FILTER (lang(?secondClassLabelLg1) = '" + config.getLg1() + "')  . \n"
				+ "OPTIONAL {?secondClassURI skos:prefLabel ?secondClassLabelLg2 . \n"
				+ "FILTER (lang(?secondClassLabelLg2) = '" + config.getLg2() + "') }  . \n"
				+ "OPTIONAL {?secondClassURI skos:altLabels ?secondAltLabelLg1 . \n"
				+ "FILTER (lang(?secondAltLabelLg1) = '" + config.getLg1() + "') } . \n"
				+ "OPTIONAL {?secondClassURI skos:altLabels ?secondAltLabelLg2 . \n"
				+ "FILTER (lang(?secondAltLabelLg2) = '" + config.getLg2() + "') } . \n"
				+ "}"
				+ "LIMIT 1";
	}
	...
	public static String correspondenceAssociationQuery(String correspondenceId, String associationId) {
		...
		return "SELECT ?correspondenceId ?associationId ?labelLg1 ?labelLg2 ?scopeNoteLg1 ?scopeNoteLg2 \n"
				...
				+ "OPTIONAL {?sourceClassURI skos:altLabels ?sourceClassAltLabelLg1 . \n"
				+ "FILTER (lang(?sourceClassAltLabelLg1) = '" + config.getLg1() + "') } . \n"
				+ "OPTIONAL {?sourceClassURI skos:altLabels ?sourceClassAltLabelLg2 . \n"
				+ "FILTER (lang(?sourceClassAltLabelLg2) = '" + config.getLg2() + "') } . \n"
				...
				+ "OPTIONAL {?targetClassURI skos:altLabels ?targetClassAltLabelLg1 . \n"
				+ "FILTER (lang(?targetClassAltLabelLg1) = '" + config.getLg1() + "') } . \n"
				+ "OPTIONAL {?targetClassURI skos:altLabels ?targetClassAltLabelLg2 . \n"
				+ "FILTER (lang(?targetClassAltLabelLg2) = '" + config.getLg2() + "') } . \n"
				// items
				...
				+ "FILTER (lang(?sourceItemLabelLg1) = '" + config.getLg1() + "') \n"
				+ "OPTIONAL {?sourceItemURI skos:prefLabel ?sourceItemLabelLg2 . \n"
				+ "FILTER (lang(?sourceItemLabelLg2) = '" + config.getLg2() + "')} \n"
				...
				+ "FILTER (lang(?targetItemLabelLg1) = '" + config.getLg1() + "') \n"
				+ "OPTIONAL {?targetItemURI skos:prefLabel ?targetItemLabelLg2 . \n"
				+ "FILTER (lang(?targetItemLabelLg2) = '" + config.getLg2() + "')} \n"
				+ "} \n"
				+ "LIMIT 1";
	}
