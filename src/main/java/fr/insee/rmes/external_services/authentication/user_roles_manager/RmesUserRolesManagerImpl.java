...
@Service
public record RmesUserRolesManagerImpl(Config config, RestTemplateUtils restTemplateUtils, Map<String, UserSugoi> mapUsers) implements UserRolesManagerService {
    ...
    @Autowired
    public RmesUserRolesManagerImpl(Config config, RestTemplateUtils restTemplateUtils) {
        this(config, restTemplateUtils, new HashMap<>(NB_USERS_EXPECTED));
    }
