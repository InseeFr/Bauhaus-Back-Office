...
public class DiacriticSorter {
     ...
     */
    private static <T> List<T> sort(String jsonArray, Class<T[]> targetArrayClass, Function<T, String> keyExtractor, Optional<UnaryOperator<Stream<T>>> businessProcessor) throws RmesException {
    ...
    public static <T extends AppendableLabel<T>> List<T> sortGroupingByIdConcatenatingAltLabels(String jsonArray, Class<T[]> targetArrayClass, Function<T, String> keyExtractor) throws RmesException {
        return sort(jsonArray, targetArrayClass, keyExtractor, Optional.of(businessProcessor()));
    }

    public static <T> List<T> sort(String jsonArray, Class<T[]> targetArrayClass, Function<T, String> keyExtractor) throws RmesException {
