...
public record ColecticaItem(
        ...
        @JsonProperty("ItemName") Map<String, String> itemName,

        @JsonProperty("Label") Map<String, String> label,

        @JsonProperty("Description") Map<String, String> description,

        @JsonProperty("VersionRationale") Map<String, String> versionRationale,

        @JsonProperty("MetadataRank") Integer metadataRank,

        @JsonProperty("RepositoryName") String repositoryName,

        @JsonProperty("IsAuthoritative") Boolean isAuthoritative,
        ...
        @JsonProperty("VersionCreationType") Integer versionCreationType) {}
