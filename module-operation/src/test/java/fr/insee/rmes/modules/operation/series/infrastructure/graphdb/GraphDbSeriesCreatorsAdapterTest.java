...
class GraphDbSeriesCreatorsAdapterTest {
    ...
    @Test
    void getCreatorsForSeries_queriesGestionWithTranslatedIrisAndRemapsResultToPublicationIris() throws RmesException {
        ...
        Map<String, List<String>> result = adapter.getCreatorsForSeries(List.of(publicationIri1, publicationIri2));
    ...
    void getCreatorsForSeries_returnsEmptyMap_whenRepositoryThrows() throws RmesException {
        ...
        Map<String, List<String>> result =
                adapter.getCreatorsForSeries(List.of("http://id.insee.fr/operations/serie/s1001"));
