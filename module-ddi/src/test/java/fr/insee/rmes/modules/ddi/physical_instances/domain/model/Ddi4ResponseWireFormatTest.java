...
class Ddi4ResponseWireFormatTest {
    ...
    private static Ddi4Response aResponse() {
        return new Ddi4Response(
                ...
                List.of(new Ddi4Variable(
                        ...
                        "1",
                        null,
                        LangStrings.of("fr-FR", "AGE"),
                        LangStrings.of("fr-FR", "Âge"),
                        null,
                        null,
                        null)),
    ...
    void shouldDeserializeItemsBackIntoTypedLists() throws Exception {
        ...
        assertThat(roundTripped.dataRelationship())
                .extracting(Ddi4DataRelationship::id)
        ...
        assertThat(roundTripped.managedMissingValuesRepresentation())
                .extracting(Ddi4ManagedMissingValuesRepresentation::id)
                .containsExactly("mmvr-1");
        assertThat(roundTripped.topLevelReference()).extracting(Reference::id).containsExactly("pi-1");
    }

    @Test
    void shouldOmitEmptyEnvelopeMembers() throws Exception {
        Ddi4Response empty = new Ddi4Response(Ddi4Response.SCHEMA, null, null, null, null, null, null, null);
