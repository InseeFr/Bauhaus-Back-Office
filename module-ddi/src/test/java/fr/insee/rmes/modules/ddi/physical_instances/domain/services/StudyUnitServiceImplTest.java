...
class StudyUnitServiceImplTest {
    ...
    void getAll_shouldDelegateToRepository() {
        List<PartialStudyUnit> expected = List.of(new PartialStudyUnit("su-1", "StudyUnit 1", new Date(), "fr.insee"));
    ...
    void getAll_shouldBeSortedByLabelDescending() {
        when(studyUnitRepository.getAll())
                .thenReturn(List.of(
        ...
        assertThat(result).extracting(PartialStudyUnit::label).containsExactly("Charlie", "Bravo", "alpha");
    }
