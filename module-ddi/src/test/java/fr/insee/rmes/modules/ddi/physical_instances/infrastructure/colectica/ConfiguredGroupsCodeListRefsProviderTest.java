...
class ConfiguredGroupsCodeListRefsProviderTest {
    ...
    private final ColecticaInstanceConfiguration instanceConfiguration = new ColecticaInstanceConfiguration(
            "https://example.com", "/api/v1/", Map.of("CodeList", CODE_LIST_TYPE),
            "resp", "fmt", "token", null, null, DEFAULT_AGENCY);
    ...
    void queriesCodeListChildrenOfEachConfiguredGroup_usingDefaultAgency_oneCallPerGroup() {
        stubGroupChildren("group-1", new ItemReference(DEFAULT_AGENCY, "cl-1"), new ItemReference(DEFAULT_AGENCY, "cl-2"));
    ...
    void deduplicatesCodeListRefsSharedAcrossGroups() {
        ...
        stubGroupChildren("group-2", new ItemReference(DEFAULT_AGENCY, "cl-shared"), new ItemReference(DEFAULT_AGENCY, "cl-x"));
