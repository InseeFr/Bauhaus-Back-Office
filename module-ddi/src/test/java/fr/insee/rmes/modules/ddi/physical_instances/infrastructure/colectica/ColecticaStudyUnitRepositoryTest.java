...
class ColecticaStudyUnitRepositoryTest {
    ...
    private ColecticaStudyUnitRepository repository() {
        var instanceConfig = new ColecticaConfiguration.ColecticaInstanceConfiguration(
                "http://localhost:8082", "/api/v1/", null, "bauhaus",
                "DC337820-AF3A-4C0B-82F9-CF02535CDE83", "token", null, null, "fr.insee");
    ...
    void addPhysicalInstance_preservesLogicalProductReferences() {
        ...
        Ddi4StudyUnit studyUnit = new Ddi4StudyUnit(Ddi4StudyUnit.TYPE,
                ...
                "urn:ddi:fr.insee:su-1:1", "fr.insee", "su-1", "1",
        ...
        assertThat(updated.physicalInstanceReferences())
                .extracting(Reference::id).containsExactly("pi-1");
        assertThat(updated.logicalProductReferences())
                .containsExactly(logicalProductReference);
    }
}
